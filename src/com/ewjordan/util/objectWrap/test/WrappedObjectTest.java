...
import com.ewjordan.util.objectWrap.PrimitiveReference;
...
class TestHolder {
	...
	@Unwrapped public int[] publicIntArray = new int[10]; //should be ignored due to @Unwrapped
...
public class WrappedObjectTest {
	...
	/**
	 * Test method for {@link com.ewjordan.objectWrap.WrappedObject#pushValuesToObject()}.
	 */
	@Test
